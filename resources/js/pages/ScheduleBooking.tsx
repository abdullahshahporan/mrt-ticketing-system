...
const ScheduleBooking: React.FC = () => {
  ...
  const handleBooking = async () => {
    if (!fromStation || !toStation || !contactNumber || !bookingDate || !travelTime) {
      alert('Please fill in all required fields including travel time');
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        ...
        alert(`Booking successful! Your PNR is: ${data.base_pnr}`);
        // You can navigate to a confirmation page
